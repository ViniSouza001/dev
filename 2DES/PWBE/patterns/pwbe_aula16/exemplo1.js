...
class Aluguel {
    constructor(id,veiculo, dataRetirada, dataDevolucao) {
        ...
        this.dataRevolucao = new Date(dataDevolucao);
        this.valorAluguel = Number(((new Date(dataDevolucao) - new Date(dataRetirada)) / (1000 * 60 * 60 * 24) * veiculo.diaria).toFixed(2));
        //   valorAluguel = (diferença entre(a data da devolução) e (a data da retirada) / pelo numero de dias * o preço da diaria). Irá mostrar apenas duas casas decimais
    }
}
