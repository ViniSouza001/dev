...
Create table Funcionarios(
	...
	Cidade varchar(30),
	Estado varchar(2),
	constraint pk_func_1 primary key(Cod_Func) -- Cod_Func é a chave primária
);

Create table Departamentos(
	Cod_Depto numeric(4) not null,
	Nome_Depto varchar(50) not null,
	constraint pk_dep_1 primary key(Cod_Depto) -- Cod_Depto é a chave primária
); 

Create table Produtos(
	Cod_Produto numeric(4) not null,  
	Nome_produto varchar(50) not null,
	constraint pk_prod_1 primary key(Cod_Produto) -- Cod_Produto é a chave primária
);
...
Create table Solicitacoes(
	...
	constraint fk_sol_dep_1 Foreign Key(Cod_Depto) references Departamentos(Cod_Depto), -- Cod_Depto é a chave primária e está sendo ligada com a chave Cod_Depto da tabela Departamentos
