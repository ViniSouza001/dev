...
(null,'Tomar o cafe da manha',TIMESTAMPADD(MINUTE,-1400,now())),
(null,'Dirigir ate o trabalho',TIMESTAMPADD(MINUTE,-1350,now())),
(null,'Voltar pra casa',TIMESTAMPADD(HOUR,-15,now())),
(null,'Comer',TIMESTAMPADD(HOUR,-14,now())),
(null,'Assistir Serie',TIMESTAMPADD(HOUR,-13,now())),
(null,'Acordar',now()),
...
(null,'Tomar o cafe da manha',TIMESTAMPADD(MINUTE,40,now())),
(null,'Dirigir ate o trabalho',TIMESTAMPADD(MINUTE,50,now())),
(null,'Voltar pra casa',TIMESTAMPADD(HOUR,9,now())),
(null,'Comer',TIMESTAMPADD(HOUR,10,now())),
(null,'Assistir Serie',TIMESTAMPADD(HOUR,11,now())),
...
(null,'Tomar o cafe da manha',TIMESTAMPADD(MINUTE,1490,now())),
(null,'Dirigir ate o trabalho',TIMESTAMPADD(MINUTE,1500,now())),
(null,'Voltar pra casa',TIMESTAMPADD(HOUR,33,now())),
(null,'Comer',TIMESTAMPADD(HOUR,34,now())),
(null,'Assistir Serie',TIMESTAMPADD(HOUR,35,now()));
